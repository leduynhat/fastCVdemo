...
//                    Log.i(TAG, "onPreviewFrame: data [580095]= " + data[580095] + ", [576000]= " + data[576000] + ", [575999]= " + data[575999] + ", [384000]= " + data[384000]);
    ...
    protected Runnable mUpdateTimeTask = new Runnable() {
        ...
        public void run() {
            ...
            for (TextView textView : mText) {
                if (textView.getText().length() > 0) {
                    textView.setBackgroundColor(mBackgroundColor);
                } else {
                    textView.setBackgroundColor(0x00);
                }
            }
        }
    };
...
//      changeOrientation();
    ...
    protected void setupCamera() {
        ...
        // the preview.
        int _desiredHeight = mDesiredHeight;
...
//            Log.i(TAG, "Supported Preview Size: h:" + s.height + ", w: " + s.width);
        ...
        Log.i(TAG, "setupCamera: h:" + mPreviewHeight + ", w: " + mPreviewWidth);
    }
...
//        Log.i(TAG, "setCallback: bit per pixel: " + bitsPerPixel);
    ...
    public void changeOrientation() {
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            mGLSurface.setRotation(0);
            Log.i(TAG, "Camera landscape, now change to portrait");
        } else {
